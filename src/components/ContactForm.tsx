...
const ContactPage = () => {
  ...
  return (
    <div className="py-20 relative cursor-not-allowed min-h-screen bg-gradient-to-t from-black to-red-950 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-white md:text-xl text-center mb-5">
        ...
        <div className="bg-gradient-to-t from-black to-red-950 backdrop-blur-sm rounded-xl shadow-2xl p-8 border border-red-800/50">
          ...
          <form
            action="https://formspree.io/f/mnnqonjo"
            method="POST"
