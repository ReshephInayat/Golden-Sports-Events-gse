                ...
                <div className="absolute top-48 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center text-bold  ">
                  <div className="lg:flex lg:justify-center">
                    ...
                    >
                      ...
                      company specializing in sports events. We pride ourselves
                      on delivering exceptional sports experiences, creating
                      memorable moments for athletes, spectators, and sponsors
                      alike. With a dedicated team of professionals and a
                      passion for sports, we strive to exceed expectations and
                      ensure the success of every event we undertake.
                    </motion.p>
                  </div>
                  <Link href={`/${"#about"}`}>
                    <motion.button
